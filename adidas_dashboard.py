...
image = Image.open(r'C:\Users\karna\OneDrive\Documents\Streamlit\Adidas Dashboard\download.png')
...
with dwn1:
    st.download_button("Get Data", data = data.to_csv().encode("utf-8"),
                       file_name="RetalierSales.csv", mime="text/csv")
...
#add the inits sold as a line chart on a secndary y-axis
fig3 = go.Figure()
...
_, view3, dmn3 = st.columns([0.5, 0.45,0.45])
with view3:
...
_, view5, dwn5 = st.columns([0.5,0.45,0.450])
with view5:
